        ...
        <div v-show="activeTab === 'gold-report'">
            ...
            <section class="bg-white rounded-xl p-6 shadow-md mb-8">
                <div class="flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex-1">
                        <label for="customer-id" class="block text-sm font-medium text-gray-700 mb-1">Customer
                            ID</label>
                ...
                <div ref="reportContent" class="space-y-8">
                    ...
                    <section class="bg-gradient-to-r from-amber-500 to-yellow-500 rounded-xl p-6 shadow-lg text-white">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            ...
                            <div class="bg-white/20 backdrop-blur p-4 rounded-lg text-center">
                                ...
                                <div class="text-2xl font-bold">{{ goldData.summary?.current_gold_price?.buy_rate }}
                                </div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <div class="flex justify-between">
                                ...
                                <div
                                    ...
                                    <svg v-if="goldData.summary?.is_overall_profitable"
                                        xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-500" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <section class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="h-36 mt-4">
                                    <ClientOnly>
                                        <GoldPortfolioDonut v-if="goldData.summary?.total_gold_weight"
                    ...
                    <section v-if="hasSellData || hasP2PData" class="bg-white rounded-xl p-6 shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div
                                class="bg-gradient-to-r from-green-500 to-emerald-600 to-yellow-600 text-white p-5 rounded-lg">
                    ...
                    <section class="bg-white rounded-xl p-6 shadow-md">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-xl font-bold">Buy Gold Tra</h2>
                            <div class="flex space-x-4">
                                <button @click="toggleAllTransactions"
                                    class="text-sm text-blue-600 hover:text-blue-800">
                                    {{ showAllTransactions ? 'Show Less' : 'Show All' }}
                                </button>
                                <button @click="exportToPDF" :disabled="!canExport" :class="[
                                ...
                                <button @click="exportToExcel" :disabled="!canExport" :class="[
                                    'text-sm flex items-center',
                                    canExport ? 'text-blue-600 hover:text-blue-800' : 'text-gray-400 cursor-not-allowed'
                                ]">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none"
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="(transaction, index) in displayedTransactions" :key="index"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{
                                            transaction.gold_weight }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{
                                            transaction.purchase_price_per_gram
                                        }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{
                                            transaction.current_price_per_gram
                                        }}</td>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div class="bg-indigo-50 p-4 rounded-lg">
                                ...
                                <div class="text-xl font-bold text-indigo-800">{{
                                    p2pGoldData.summary?.total_transactions }}</div>
                            </div>
                            <div class="bg-indigo-50 p-4 rounded-lg">
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="(transaction, index) in p2pGoldData.transactions" :key="index"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                :class="{ 'px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full': true, 'bg-green-100 text-green-800': isIncomingTransfer(transaction), 'bg-blue-100 text-blue-800': !isIncomingTransfer(transaction) }">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span
                                                ...
                                                <span v-if="isMyAccount(transaction.debit_account)"
                                                    class="text-xs text-blue-600 ml-1">(My
                                                    Account)</span>
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div class="bg-amber-50 p-4 rounded-lg">
                                ...
                                <div class="text-xl font-bold text-amber-800">{{
                                    sellGoldData.summary?.total_transactions }}</div>
                            </div>
                            <div class="bg-amber-50 p-4 rounded-lg">
