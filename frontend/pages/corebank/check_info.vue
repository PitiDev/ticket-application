...
// Search data for different tabs
...
// Computed property to check if search is valid
...
// Computed property to get client info from different API response structures
...
// Clear results when search data changes
watch(searchData, () => {
