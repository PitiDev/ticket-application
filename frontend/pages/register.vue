...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-amber-50 dark:from-gray-900 dark:to-gray-800 flex justify-center p-4 transition-colors duration-200">
    <div class="w-full max-w-lg">
      <div class="text-center mb-8">
        <div class="inline-block p-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl mb-4 transition-colors duration-200">
        ...
        <p class="text-gray-500 dark:text-gray-400 mt-2">Sign up for a new {{ appName }} account</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-colors duration-200">
        ...
        <div v-if="!allowRegistration" class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-600 p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-yellow-700 dark:text-yellow-300">Registration is currently disabled. Please contact administrator.</p>
            </div>
          </div>
        </div>

        <!-- Error Alert -->
        <div v-if="error" class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-700 p-4">
          <div class="flex">
            <div class="flex-shrink-0">
        ...
        <div class="p-8">
            ...
            <div class="space-y-2">
              ...
              <div class="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  type="text"
                  required
                  class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                  placeholder="johndoe"
                />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  required
                  class="block w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                ...
                >
                  <svg v-if="showPassword" class="h-5 w-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-5 w-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div class="mt-1">
                ...
                <p v-if="formData.password" class="text-xs mt-1 text-gray-500 dark:text-gray-400">
                  Password strength: <span :class="{ 'text-red-600 dark:text-red-400': passwordStrength.score < 3, 'text-green-600 dark:text-green-400': passwordStrength.score >= 3 }">{{ passwordStrength.text }}</span>
                </p>
                <p v-else class="text-xs mt-1 text-gray-500 dark:text-gray-400">Password must be at least 8 characters</p>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative rounded-md shadow-sm">
                ...
                <button
                  ...
                  class="absolute inset-y-0 right-0 pr-3 flex items-center"
                >
                  <svg v-if="showConfirmPassword" class="h-5 w-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-5 w-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p v-if="formData.password && formData.confirm_password && formData.password !== formData.confirm_password" class="text-xs text-red-600 dark:text-red-400 mt-1">
            ...
            <div class="flex items-start">
              <div class="flex items-center h-5">
                <input
                  ...
                  type="checkbox"
                  class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded transition-all duration-200"
                />
              </div>
              <div class="ml-3 text-sm">
                <label for="terms" class="font-medium text-gray-700 dark:text-gray-300">I agree to the terms and conditions</label>
                <p class="text-gray-500 dark:text-gray-400">By creating an account, you agree to our <a href="#" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">Terms of Service</a> and <a href="#" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">Privacy Policy</a>.</p>
              </div>
            </div>
          ...
          <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
              ...
              <NuxtLink
                to="/login"
                class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-all duration-200"
              >
                Sign in instead
              </NuxtLink>
            </p>
