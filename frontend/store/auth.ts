  ...
  actions: {
    ...
    async login(credentials: { email: string; password: string }): Promise<{ token: string; user: User }> {
      ...
      try {
        ...
        const response = await fetch('https://ticket.laobullionbank.com/api/users/login', {
          method: 'POST',
          headers: {
    ...
    async fetchProfile(): Promise<User> {
      ...
      try {
        ...
        const response = await fetch('https://ticket.laobullionbank.com/api/users/profile', {
          headers: {
